...
-   **Materiales:**
    ...
    -   Las presentaciones y ciertas tablas de datos se encuentran en el [sitio web del curso](https://mmorenozam.github.io/est-apl-uce-2023-website/){target="_blank"}, otros datos utilizados serán presentados a lo largo del curso

-   **Canales de comunicación:**

    -   Plataforma ZULIP

    -   Email del instructor: mmorenozambrano\@gmail.com
:::
...
-   **Estructura de cada sesión:**
    ...
    -   Un receso de 10 minutos en la mitad de cada sesión

-   **Trabajo final del curso:**

    -   Realización de un reporte estadístico
...
::: incremental
-   La estructura básica que espero de un reporte estadístico es la mínima establecida por el método científico (título, resumen, objetivos, metodología, resultados, conclusiones y biobliografía).

-   Lo importante es brindar al participante el conocimiento necesario para redactar resultados estadísticos de una manera entendible para el público en general.

-   **NO ES NECESARIO** seguir ninguna norma de citación biobliográfica (o sección de biobliografía de ser el caso).

-   **ES IMPRESCINDIBLE** el presentar el código de R (script) usado en el reporte a manera de Apéndice.

-   Envío del reporte final debe ser hasta antes de las 23H59 GMT-5 (hora de Ecuador continental) del 7 de abril del año en curso en formato pdf al correo electrónico del instructor (mmorenozambrano\@gmail.com).

-   La nota del reporte será entregada de manera individual a cada participante hasta el 14 de abril del año en curso al correo del cual fue remitido el mismo.

-   El instructor entregará el reporte final de notas a la Coordinación de Educación Continua de la Facultad de Ciencias Biológicas de la UCE el 18 de abril.
:::

## Recomendaciones 

::: incremental
-   Comunícame si tu ordenador usa un sistema operativo distinto a Windows (MacOS o Linux)
...
-   No existe pregunta más tonta que la que no se hace
...
::: incremental
-   Durante el curso se espera que sigas y reproduzcas en tu ordenador en tiempo real el código de R que escribiré para cada ejemplo. ¡**NO DESESPERES** si no alcanzas mi ritmo! Cada sesión es grabada y la subiré inmediatamente a un canal privado de YouTube para que puedas recurrir al mismo de ser necesario.
...
# Introducción a R {transition="slide"}
...
1.  Editor: ventana donde escribimos código. Puede contener tantas subpestanas como scripts de R tengamos abiertos. No se ejecuta a no ser que ordenemos a R hacerlo.
...
::: incremental
-   O mas de una librería a la vez:
:::
...
::: incremental
Cuando R importa tablas de datos, si encuentra nombres de columnas con números como el primer caracter, o con espacios vacíos dentro del mismo, reformatea automáticamente dichos valores.
:::
...
**Tip: basta con que veas la ayuda de una sola función para revisar el argumento que tienes que modificar. El mismo argumento es común a todas las demas funciones**
...
# ¡Antes de terminar por hoy! {transition="slide"}
