...
-   Opción 1:
    ...
    -   La estructura básica que espero de un reporte estadístico es : título, resumen, objetivos, metodología, resultados, conclusiones (bibliografía dependiendo si tiene sentido ponerla).
...
-   Opción 2:
    ...
    -   Resolver las preguntas establecidas como sugerencia en el sitio web del curso en base a tablas de datos disponibles en librerías de R y compartidas con el resto de tablas de datos externas.

-   **ES IMPRESCINDIBLE** el presentar el código de R (script) usado en el reporte a manera de Apéndice, independientemente de la opción que optes para tu trabajo final.

-   Envío del reporte final debe ser hasta antes de las 23H59 GMT-5 (hora de Ecuador continental) del 19 de abril del año en curso en formato pdf a mi correo electrónico (mmorenozambrano\@gmail.com).
